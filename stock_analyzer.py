...
# ============================================================================
# TRANSLATIONS DICTIONARY - Bilingual Support (CZ/EN)
# ============================================================================
TRANSLATIONS = {
    "en": {
        "app_name": "Stock Picker Pro",
        ...
        "ai_loading": "Generating hardcore AI analysis...",
        ...
        "pe_help": "Price-to-Earnings ratio. Compares stock price to earnings per share. Lower P/E typically means the stock is cheaper relative to earnings.",
        "beta_help": "Volatility measure relative to the market. Beta > 1 means more volatile than market. Beta < 1 means more stable.",
        "div_yield_help": "Annual dividend payment as percentage of stock price. Higher yield means more income for investors.",
        "dcf_help": "Discounted Cash Flow fair value. Intrinsic value based on projected future cash flows discounted to present value.",
        "wacc_help": "Weighted Average Cost of Capital. Represents the company's risk level. Higher WACC = higher risk = lower fair value.",
        "roe_help": "Return on Equity. Shows how efficiently the company uses shareholder money to generate profit. Higher is better, >15% is excellent.",
        "roic_help": "Return on Invested Capital. Measures efficiency of capital deployment. >15% is excellent, <8% may indicate value destruction.",
        "debt_to_equity_help": "Debt-to-Equity ratio. Shows financial leverage. <1 is conservative, >2 may be risky (depends on sector).",
        "fcf_yield_help": "Free Cash Flow Yield. Annual FCF as percentage of market cap. Higher = better value. >5% is attractive.",
        "sector_crypto": "🪙 CRYPTO detected - ignoring P/E, focusing on adoption & regulation",
        "sector_bank": "🏦 BANK/FINTECH detected - focusing on interest rates & competition",
        "sector_biotech": "💊 BIOTECH detected - checking patent expiration risks",
        "sector_value_trap": "⚠️ Price down >50% from ATH - is this a discount or collapse?",
        "negative_fcf": "N/A (Negative Cash Flow)",
        "dcf_na": "N/A (DCF not applicable)",
    ...
    "cz": {
        ...
        "ai_loading": "Generuji hardcore AI analýzu...",
        ...
        "pe_help": "Poměr Cena/Zisk. Porovnává cenu akcie k zisku na akcii. Nižší P/E obvykle znamená, že akcie je levnější relativně k zisku.",
        "beta_help": "Míra volatility vzhledem k trhu. Beta > 1 znamená volatilnější než trh. Beta < 1 znamená stabilnější.",
        "div_yield_help": "Roční dividendová platba jako procento z ceny akcie. Vyšší výnos znamená více příjmů pro investory.",
        "dcf_help": "Diskontovaný peněžní tok - férová hodnota. Vnitřní hodnota založená na projekci budoucích peněžních toků diskontovaných na současnou hodnotu.",
        "wacc_help": "Vážený průměr nákladů kapitálu. Reprezentuje úroveň rizika společnosti. Vyšší WACC = vyšší riziko = nižší férová hodnota.",
        "roe_help": "Návratnost vlastního kapitálu. Ukazuje, jak efektivně firma využívá peníze akcionářů k tvorbě zisku. Vyšší je lepší, >15% je výborné.",
        "roic_help": "Návratnost investovaného kapitálu. Měří efektivitu nasazení kapitálu. >15% je výborné, <8% může indikovat ničení hodnoty.",
        "debt_to_equity_help": "Poměr Dluh/Vlastní kapitál. Ukazuje finanční páku. <1 je konzervativní, >2 může být rizikové (závisí na sektoru).",
        "fcf_yield_help": "Výnos volného peněžního toku. Roční FCF jako procento z tržní kapitalizace. Vyšší = lepší value. >5% je atraktivní.",
        "sector_crypto": "🪙 KRYPTO detekováno - ignoruji P/E, zaměřuji se na adopci & regulaci",
        "sector_bank": "🏦 BANKA/FINTECH detekována - zaměřuji se na úrokové sazby & konkurenci",
        "sector_biotech": "💊 BIOTECH detekován - kontroluji rizika expirace patentů",
        "sector_value_trap": "⚠️ Cena spadla >50% z ATH - je to sleva nebo krach?",
        "negative_fcf": "N/A (Záporný Cash Flow)",
        "dcf_na": "N/A (DCF není aplikovatelný)",
        "data_source": "Data: Yahoo Finance",
...
def t(key: str, lang: str = "cz", **kwargs) -> str:
    ...
    return text  # Optimized for Free Tier
MAX_AI_RETRIES = 3  # Retry logic for rate limits
RETRY_DELAY = 2  # seconds
